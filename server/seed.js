...
function seedIfEmpty() {
  ...
  if (count > 0) {
    console.log('Base déjà peuplée (' + count + ' utilisateur(s)), seed ignoré.');
    return false;
  }
  ...
  console.log('  admin@rd.local / admin123');
  console.log('  thomas@rd.local / admin123');
  console.log('  sophie@rd.local / admin123');
  return true;
}
